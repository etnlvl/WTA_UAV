            ...
            if len(dist) != 0:
                ...
                for drone in drones_alive:
                    ...
                    for weapon in self.weapons_with_ammo:
                        if weapon.range_window[0] <= np.linalg.norm(drone.pos - np.array([0, 0, 0])) <= weapon.range_window[1]:
                ...
                for index, w in enumerate(self.weapons_with_ammo):
                    ...
                    reward_matrix[index] = reward_matrix[index] * [feed_mip.get_value_function_v1(drone) for drone in drones_alive]
...
# ## Run the simulation ##
#
# sim3 = Sim_dynamic(20, 1, base, weigths)
