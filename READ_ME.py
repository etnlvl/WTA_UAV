...
" store the different variables of the environment. For example, the Drone class "
"file will be used to store and update the important elements of each drone such as its position,"
